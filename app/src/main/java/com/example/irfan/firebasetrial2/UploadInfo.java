...
/**
 * Created by user-ASUS on 27/12/2017.
 */
...
public class UploadInfo extends AppCompatActivity{
        ...
        if (imgUri!=null){
            ...
            ref.putFile(imgUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    //dismiss diaolog when success
                    dialog.dismiss();
                    //displat succes toastmStorageRef = FirebaseStorage.getInstance().getReference();
    ...
    public void btnShowListImage_Click(View v) {
        Intent i = new Intent(UploadInfo.this,ImageListActivity.class);
        startActivity(i);
    }
}
